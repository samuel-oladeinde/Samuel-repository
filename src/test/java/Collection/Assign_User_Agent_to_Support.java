...
public class Assign_User_Agent_to_Support extends TestBase {
    @Test(priority = 1)
    @Severity(SeverityLevel.CRITICAL)
    @Description("An Endpoint to Add Phrase To Service 200")
    @Story("An Endpoint to Add Phrase To Service 200")
    public void Assign_User_Agent_to_Support_200() throws InterruptedException, IOException {
    ...
    public void Assign_User_Agent_to_Support_401() throws InterruptedException, IOException {
    ...
    public void Assign_User_Agent_to_Support_403() throws InterruptedException, IOException {

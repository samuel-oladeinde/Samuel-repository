...
public class ActivateTeam extends TestBase {
    ...
    @Description("An Endpoint to Activate Team 200")
    @Story("An Endpoint to Activate Team 200")
    public void ActivateTeam_200() throws InterruptedException, IOException {
